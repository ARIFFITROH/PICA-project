...
<body>
	...
	<div class="container">
		...
		<div class="row">
				<div class="col-sm  m-2">
					<div class="small-box bg-white border text-black text-center">
						<div class="inner">
							<h3><?php echo ($totalareal); ?> Ha</h3>
							<p><?php echo $judul_total_Areal; ?></p>
						</div>
						<div class="icon">
							...
							if(count($arr_data) > 0){
								...
								foreach($arr_data as $key => $val ){
									echo '<tr>'.
									  ...
									  '<td class="text-center">'. $val['afdeling'].'</td>'.
